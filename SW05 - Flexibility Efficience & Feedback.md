...
- CookPad
    ...
    ![Figure 1 : Settings screen - CookPad](2438e89c-75cf-44ae-93e5-f61b07b195e6.png)
    
    Figure 1 : Settings screen - CookPad
    
    ![Figure 2 : Screen after clicking on theme tab - CookPad](f376dbce-9c67-4e9d-8872-3e33a64f8759.png)
...
- Tasty
    ...
    - Ingredient substitution: There is no flexibility when it comes to ingredient substitutions on specific recipes as you can see on figure 3 . Once you click on a recipe it shows you the reviews, list of ingredients, steps, etc, but there is no opportunity for the user to substitute the ingredients in the case of allergies.
        ...
        ![Figure 3 : Recipe screen - Tasty App](IMG_4031.jpeg)
    ...
    ![Figure 4 : Recipe Screen - Tasty](d3b0b39e-a489-4e1b-ab8b-d1237d86bc8f.png)
    
    Figure 4 : Recipe Screen - Tasty
    
    ![Figure 5 : Screen after clicking on “Start Cooking” button](40468f06-bed2-4560-8b17-b8f9a3d82618.png)
    ...
    ![Figure 6 : Display of Tasty App Screen after registering on the app](e8aecf97-934c-479a-846e-d5f61ff19b0c.png)
    
    Figure 6 : Display of Tasty App Screen after registering on the app
    
    ![Figure 7 : Next step after registering on Tasty App, questions on the expectations of the user.](9a371ebc-193b-47c8-9d06-8becfc36ae12.png)
...
- CookPad
    ...
    ![Figure 8: CookPad Menu View](8a1a6d3b-4678-49d7-b361-bd3c18f0d95a.png)
    
    Figure 8: CookPad Menu View
    
    ![Figure 9 : CookPad “Send Feedback” Screen](2cad66d7-dd14-4d98-bc4a-6a70da97be7e.png)
    
    Figure 9 : CookPad “Send Feedback” Screen
    
    ![Figure 10 : Screen when reporting & blocking a user - CookPad App](1ca22892-3c97-40d0-a2e4-bf1c3542f3f2.png)
...
- Tasty
    ...
    ![Figure 11 : Feedback screen displaying error - Tasty App](4b433672-8eca-48c5-bced-7e1b8080f317.png)
...
![Screenshot 2024-10-22 233349.png](Screenshot_2024-10-22_233349.png)
...
![Screenshot 2024-10-22 232707.png](2231ee16-f0a7-4cfa-8217-e2727ed834f8.png)
...
![Screenshot 2024-10-23 000033.png](Screenshot_2024-10-23_000033.png)
...
![Screenshot 2024-10-23 at 11.20.03.png](Screenshot_2024-10-23_at_11.20.03.png)